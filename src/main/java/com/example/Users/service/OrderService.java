...
// // public ResponseEntity<?> save(userOrders userOrders, String token, String
// simbolo) {
...
// List<userOrders> ordersList = repository.tipoEstock(order_recebida.getType()
// == 1 ? 2 : 1,
// order_recebida.getId_stock(), order_recebida.getId_user());

// for (userOrders order : ordersList) {
// if (order_recebida.getType() == 1 ? order.getPrice() <=
// order_recebida.getPrice()
...
// if (order_recebida.getType() == 1 ? order_user.getDollar_balance() >=
// order.getPrice()
...
// order_user.setDollar_balance(order_user.getDollar_balance() -
// order.getPrice());
