...
public class UserController {
    ...
    @PostMapping
    public ResponseEntity<?> save(@RequestBody userModels users, Object getPassword, Object getUsername) {
        ...
        if (users != null && users.equals(getUsername)) {
            return ResponseEntity.badRequest().body("O campo 'Username' não pode estar vazio!");
        }
        if (users != null && users.equals(getPassword)) {
